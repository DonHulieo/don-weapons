...
Config.WeaponsDamage = {
    ...
    [`WEAPON_NIGHTSTICK`] = {model = `WEAPON_NIGHTSTICK`, modifier = 0.3, disableCriticalHitsHits = true},
    ...
    [`WEAPON_NIGHTSTICK`] = {model = `WEAPON_NIGHTSTICK`, modifier = 0.3, disableCriticalHits = true},
    ...
    [`WEAPON_REVOLVER`] = {model = `WEAPON_REVOLVER`, modifier = 0.4, disableCriticalHits = true},
    ...
    [`WEAPON_PISTOL_MK2`] = {model = `WEAPON_PISTOL_MK2`, modifier = 0.3, disableCriticalHits = true},
    [`WEAPON_COMBATPISTOL`] = {model = `WEAPON_COMBATPISTOL`, modifier = 0.2, disableCriticalHits = true},
    ...
    [`WEAPON_HEAVYPISTOL`] = {model = `WEAPON_HEAVYPISTOL`, modifier = 0.2, disableCriticalHits = true},
    [`WEAPON_VINTAGEPISTOL`] = {model = `WEAPON_VINTAGEPISTOL`, modifier = 0.3, disableCriticalHits = true},
    ...
    [`WEAPON_MICROSMG`] = {model = `WEAPON_MICROSMG`, modifier = 0.3, disableCriticalHits = true},
    [`WEAPON_MINISMG`] = {model = `WEAPON_MINISMG`, modifier = 0.2, disableCriticalHits = true},
    [`WEAPON_SMG`] = {model = `WEAPON_SMG`, modifier = 0.2, disableCriticalHits = true},
